...
component {
	...
	// Module Entry Point
	this.entryPoint			= "placetel";
	// Model Namespace
	this.modelNamespace		= "placetel";
	// CF Mapping
	this.cfmapping			= "placetel";
	// Module Dependencies
	this.dependencies 		= [];
	...
	function configure(){
		...
		interceptorSettings = {
			customInterceptionPoints = "placetel_IncomingCall,placetel_CallAccepted,placetel_HungUp"
		};
